...
export function Projects() {
    ...
    return (
        ...
        >
            ...
            <div
                ref={cursorLabelRef}
                className="fixed top-0 left-0 w-20 h-20 bg-[#49e619] rounded-full flex items-center justify-center text-black font-bold text-sm pointer-events-none z-50 opacity-0 -translate-x-1/2 -translate-y-1/2 hidden md:flex mix-blend-difference"
            >
                VIEW
            </div>
