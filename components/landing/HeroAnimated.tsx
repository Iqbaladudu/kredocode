...
export function HeroAnimated() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full flex justify-center bg-white overflow-hidden py-7 md:py-32 px-4 md:px-10 lg:px-20"
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* <div className="absolute inset-0 bg-white mask-[radial-gradient(ellipse_at_center,transparent_20%,black)]" /> */}
      </div>

      <div className="w-full flex flex-col lg:flex-row items-center gap-12 md:gap-24 relative z-10">
        {/* Left Content */}
        <div className="flex flex-col gap-6 md:gap-8 w-full lg:w-1/2 items-start text-center lg:text-left">
          {/* Title */}
          <h1
            ref={titleRef}
            className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight text-slate-900 mx-auto md:mx-0"
          >
            Building Digital <br />
            <span className="relative inline-block">
              Excellence
              <span className="absolute bottom-1 md:bottom-2 left-0 w-full h-2 md:h-3 bg-black/30 -z-10 transform -rotate-1 rounded-sm"></span>
            </span>
          </h1>
        ...
        {/* Right Image */}
        <TiltCard tiltAmount={5} className="lg:w-1/2 w-full">
          <div
