...
export function Hero() {
    return (
        <div className="relative w-full flex justify-center py-12 md:py-24 px-4 md:px-10 lg:px-40 bg-[#f6f8f6] dark:bg-[#152111]">
            <div className="w-full max-w-[1200px] flex flex-col-reverse lg:flex-row items-center gap-12">
                {/* Left Content */}
                <div className="flex flex-col gap-6 lg:w-1/2 items-start">
                    <div className="inline-flex items-center px-3 py-1 rounded-full border border-[#49e619]/30 bg-[#49e619]/10 text-[#49e619] text-xs font-bold uppercase tracking-wider">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight tracking-tight text-slate-900 dark:text-white">
                        Scalable Software{" "}
                        <span className="text-[#49e619]">Solutions</span> for Enterprise
                    </h1>

                    <p className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed max-w-lg">
                        We build robust, high-performance applications tailored to your business needs using cutting-edge technology. From ideation to deployment, we are your partners in digital transformation.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4 mt-4 w-full sm:w-auto">
                        <button className="h-12 px-8 bg-[#49e619] hover:bg-[#49e619]/90 text-[#152111] rounded-full font-bold text-base transition-all shadow-[0_0_20px_rgba(73,230,25,0.3)] hover:shadow-[0_0_30px_rgba(73,230,25,0.5)]">
                            Get Started
                        </button>
                ...
                <div className="lg:w-1/2 relative group">
                    <div className="absolute inset-0 bg-[#49e619]/20 blur-[100px] rounded-full opacity-50"></div>
                    <div className="relative w-full aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border border-slate-200 dark:border-[#2c4724] bg-slate-100 dark:bg-[#20321a] transform transition-transform duration-500 hover:scale-[1.02]">
                        ...
                        <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-white/10 dark:bg-white/10 backdrop-blur-md border border-white/20 flex items-center gap-4">
                            <div className="size-10 rounded-full bg-[#49e619] flex items-center justify-center text-[#152111]">
