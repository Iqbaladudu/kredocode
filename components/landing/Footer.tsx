...
export function Footer() {
  return (
    <footer
      className="w-full bg-white pt-16 md:pt-24 px-4 md:px-10 lg:px-20 relative overflow-hidden"
      id="contact"
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 mx-auto">
        {/* Left: CTA */}
        <div className="md:col-span-5 flex flex-col justify-between">
          <div>
            ...
            <a
              href="mailto:hello@kredocode.com"
              className="text-3xl md:text-5xl font-bold border-b-2 border-slate-900 hover:text-slate-600 transition-colors inline-block leading-tight break-all"
            >
              hello@kredocode.com
            </a>
          </div>
          ...
          <div className="mt-12 flex items-center gap-4">
            <button
              className="h-14 px-8 bg-black text-white rounded-full font-bold text-lg hover:bg-slate-800 transition-colors flex items-center gap-2"
        ...
        <div className="md:col-span-7 flex flex-wrap gap-12 md:gap-24 justify-start md:justify-end">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="#work" className="font-medium hover:underline">
              Work
            </Link>
            <Link href="#process" className="font-medium hover:underline">
              Process
            </Link>
          </div>
